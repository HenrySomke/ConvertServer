 ...
 * 出入量记录子集
 */
public class HDSD00_08_04 {
    private String CDA = "";
    public String toString() {
        return CDA;
    }

    public HDSD00_08_04(CDAData cdaData) {
        CDA =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                        ...
                        "              <!--用药频率-->\n" +
                        "              <rateQuantity value=\"" + cdaData.getCustomCol("DE06_00_133_00") + "\" unit=\"次/日\"/>\n" +
                        "              <consumable>\n" +
                        "                <manufacturedProduct>\n" +
                        ...
                        "                  <!--中药使用类别代码-->\n" +
                        "                  <value code=\"" + cdaData.getCustomCol("DE06_00_187_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.157\" codeSystemName=\"中药使用类别代码\" xsi:type=\"CD\"/>\n" +
                        "                </observation>\n" +
                        "              </entryRelationship>\n" +
                        "              <entryRelationship typeCode=\"COMP\">\n" +
                        "                <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        ...
                        "                  <!--药物使用总剂量-->\n" +
                        "                  <value xsi:type=\"PQ\" value=\"" + cdaData.getCustomCol("DE06_00_135_00") + "\" unit=\"mg\"/>\n" +
                        "                </observation>\n" +
                        "              </entryRelationship>\n" +
                        ...
                        "              <value xsi:type=\"BL\" value=\"" + cdaData.getCustomCol("DE04_01_048_00") + "\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE04.01.051.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"排尿困难标志\"/>\n" +
                        "              <value xsi:type=\"BL\" value=\"" + cdaData.getCustomCol("DE04_01_051_00") + "\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
