 ...
 * 中医住院病案首页子集
 */
public class HDSD00_12_01 {
    private String CDA = "";
    public String toString() {
        return CDA;
    }

    public HDSD00_12_01(CDAData cdaData) {
        CDA =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                        ...
                        "      <!--病案号标识-->\n" +
                        "      <id root=\"2.16.156.10011.1.13\" extension=\"" + cdaData.getCustomCol("DE01_00_004_00") + "\"/>\n" +
                        "      <!--病理号标识-->\n" +
                        "      <id root=\"2.16.156.10011.1.8\" extension=\"" + cdaData.getCustomCol("DE01_00_005_00") + "\"/>\n" +
                        "      <!--医保卡号>\n" +
                        "      <id root=\"2.16.156.10011.1.15\" extension=\"MS201102113366666\"/-->\n" +
                        "\n" +
                        "      <!-- 现住址 -->\n" +
                        "      <addr use=\"H\">\n" +
                        ...
                        "      <id root=\"2.16.156.10011.1.7\" extension=\"12341234123412341\"/>\n" +
                        "      <assignedPerson>\n" +
                        "        <name>" + cdaData.getCustomCol("DE02_01_039_00") + "</name>\n" +
                        "      </assignedPerson>\n" +
                        "    </assignedAuthor>\n" +
                        ...
                        "      <!--联系人类别，表示与患者之间的关系-->\n" +
                        "      <code code=\"" + cdaData.getCustomCol("DE02_10_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.8\" displayName=\"父子\" codeSystemName=\"家庭关系代码表（GB/T 4761）\"/>\n" +
                        "      <!--联系人地址-->\n" +
                        "      <addr use=\"H\">\n" +
                        "        <houseNumber>" + cdaData.getCustomCol("DE02_01_009_06") + "</houseNumber>\n" +
                        "        <streetName>" + cdaData.getCustomCol("DE02_01_009_05") + "</streetName>\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.172.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"门（急）诊诊断-中医诊断名称\"><qualifier><name displayName=\"中医诊断名称\"></name></qualifier></code>\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.130.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"门（急）诊诊断-中医诊断病名代码\"><qualifier><name displayName=\"中医诊断代码\"></name></qualifier></code>\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.172.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"门（急）诊诊断-中医诊断症候名称\"><qualifier><name displayName=\"中医症候名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_10_172_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.130.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"门（急）诊诊断-中医诊断症候代码\"><qualifier><name displayName=\"中医症候代码\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_10_130_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.14\" displayName=\"阳虚血瘀证\" codeSystemName=\"中医症候代码表（GB/T 15657-1995）\"/>\n" +
                        "              <!--GB的找不到此处codeSystem未改-->\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--门（急）诊诊断-西医诊断名称条目-->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.025.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"门（急）诊诊断-西医诊断名称\"><qualifier><name displayName=\"西医诊断名称\"></name></qualifier></code>\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.024.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"疾病名代码（ICD-10）\"><qualifier><name displayName=\"西医诊断代码\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.11.5\" codeSystemName=\"疾病名代码（ICD-10）\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--病理诊断-疾病名称-->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.025.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"病理诊断-疾病名称\"><qualifier><name displayName=\"病理诊断名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_01_025_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.024.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"病理诊断-疾病编码\"><qualifier><name displayName=\"病理诊断代码\"></name></qualifier></code>\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE06_00_304_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.264\" codeSystemName=\"治疗类别代码表\" displayName=\"其他\" />\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--实施临床路径 -->\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE06_00_247_00") + "\" codeSystem=\"2.16.156.10011.2.3.2.57\" codeSystemName=\"实施临床路径标志代码表\" displayName=\"中医\" />\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--住院者疾病状态代码-->\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_10_119_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.100\" codeSystemName=\"住院者疾病状态代码表\" displayName=\"未知\" />\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--住院患者损伤和中毒外部原因-->\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.172.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院中医诊断-主病名称\"><qualifier><name displayName=\"主病名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_10_172_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <!--住院患者疾病中医诊断主病编码-->\n" +
                        "              <code code=\"DE05.10.130.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院中医诊断-主病编码\"><qualifier><name displayName=\"主病代码\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_10_130_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.14\" codeSystemName=\"  中医病证分类与代码表（ GB/T 15657-1995）\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE09.00.104.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院中医诊断-主病-入院病情代码\"><qualifier><name displayName=\"中医入院病情\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE09_00_104_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.253\" codeSystemName=\"主病入院病情代码表\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--出院中医主证诊断条目-->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.10.172.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院中医诊断-主证名称\"><qualifier><name displayName=\"主证名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_10_172_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "            <observation classCode=\"OBS\" moodCode=\"EVN \">\n" +
                        "              <!--住院患者疾病中医诊断主证编码-->\n" +
                        "              <code code=\"DE05.10.130.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院中医诊断-主证-入院病情代码\"><qualifier><name displayName=\"主证代码\"></name></qualifier></code>\n" +
                        "              <!--中医诊断代码/疾病诊断名称-->\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_10_130_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.14\" codeSystemName=\"中医病证分类与代码表（ GB/T 15657-1995）\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        ...
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.025.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院西医诊断-主要诊断-疾病名称\"><qualifier><name displayName=\"主要诊断-疾病名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_01_025_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <!--住院患者疾病西医主要诊断类型代码-->\n" +
                        "              <code code=\"DE05.01.024.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"西医出院诊断-主要诊断-疾病编码\"><qualifier><name displayName=\"主要诊断疾病编码\"></name></qualifier></code>\n" +
                        "              <!--西医疾病诊断代码/疾病诊断名称-->\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.11.3\" codeSystemName=\"主要诊断疾病代码表（ICD-10）\" displayName=\"急性阑尾炎伴腹膜炎\" />\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--入院病情 -->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE09.00.104.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院西医诊断-主要诊断-入院病情代码\"><qualifier><name displayName=\"主要诊断-入院病情代码\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE09_00_104_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.253\" codeSystemName=\"入院病情代码表\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--出院西医其他诊断条目-->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE05.01.025.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院西医诊断-其他诊断名称\"><qualifier><name displayName=\"其他诊断名称\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE05_01_025_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <!--住院患者疾病西医其他诊断类型代码-->\n" +
                        "              <code code=\"DE05.01.024.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"西医出院诊断-其他诊断疾病编码\"><qualifier><name displayName=\"其他诊断疾病编码\"></name></qualifier></code>\n" +
                        "              <!--西医疾病诊断代码/疾病诊断名称-->\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.11.3\" codeSystemName=\"其他诊断疾病代码表（ICD-10）\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--出院诊断-其他诊断-入院病情 -->\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE09.00.104.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"出院西医诊断-其他诊断-入院病情代码\"><qualifier><name displayName=\"其他诊断-入院病情代码\"></name></qualifier></code>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE09_00_104_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.253\" codeSystemName=\"入院病情代码表\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE06_00_223_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.265\" codeSystemName=\"离院方式代码表\" displayName=\"医嘱离院\" />\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--拟接受医疗机构名称-->\n" +
                        ...
                        "                  <value code=\"" + cdaData.getCustomCol("DE04_50_001_00") + "\" xsi:type=\"CD\" codeSystem=\"2.16.156.10011.2.3.1.85\" codeSystemName=\"ABO血型代码表\" displayName=\"A型血\" />\n" +
                        "                </observation>\n" +
                        "              </component>\n" +
                        "              <component typeCode=\"COMP\" contextConductionInd=\"true\">\n" +
                        "                <!-- Rh血型 -->\n" +
                        ...
                        "                  <value code=\"" + cdaData.getCustomCol("DE04_50_010_00") + "\" xsi:type=\"CD\" codeSystem=\"2.16.156.10011.2.3.1.250\" displayName=\"Rh阳性\" codeSystemName=\"Rh血型代码表\"/>\n" +
                        "                </observation>\n" +
                        "              </component>\n" +
                        "            </organizer>\n" +
                        "          </entry>\n" +
                        ...
                        "                  <!--手术级别 -->\n" +
                        "                  <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE06_00_255_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.258\" codeSystemName=\"手术级别代码表\" displayName=\"特级\" />\n" +
                        "                </observation>\n" +
                        "              </entryRelationship>\n" +
                        "\n" +
                        "              <!--手术切口类别 -->\n" +
                        ...
                        "                  <value code=\"" + cdaData.getCustomCol("DE06_00_073_00") + "\" codeSystem=\"2.16.156.10011.2.3.1.159\" displayName=\"局麻\" codeSystemName=\"麻醉方式代码表\" xsi:type=\"CD\"></value>\n" +
                        "                  <!--麻醉医生-->\n" +
                        "                  <performer>\n" +
                        "                    <assignedEntity>\n" +
                        "                      <id root=\"2.16.156.10011.1.4\" extension=\"医务人员编码\"/>\n" +
                        ...
                        "              <value unit=\"次\" xsi:type=\"PQ\" value=\"" + cdaData.getCustomCol("DE02_10_090_00") + "\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
                        ...
                        "\n" +
                        "              <!-- 质控日期 -->\n" +
                        "              <effectiveTime  xsi:type=\"IVL_TS\" value=\"" + cdaData.getCustomCol("DE09_00_120_00") + "\"></effectiveTime>\n" +
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE09_00_103_00") + "\" codeSystem=\"2.16.156.10011.2.3.2.29\" codeSystemName=\"病案质量等级表\" displayName=\"一级\" />\n" +
                        "              <author >\n" +
                        "                <time/>\n" +
                        "                <assignedAuthor>\n" +
                        "                  <id root=\"2.16.156.10011.1.4\" extension=\"医务人员编码\"/>\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE07_00_007_00") + "\" displayName=\"自费\" codeSystem=\"2.16.156.10011.2.3.1.269\"  codeSystemName=\"医疗付费方式代码表\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "\n" +
                        "          <!--住院总费用 -->\n" +
                        ...
                        "              <value xsi:type=\"MO\" value=\"80000\" currency=\"元\"/>\n" +
