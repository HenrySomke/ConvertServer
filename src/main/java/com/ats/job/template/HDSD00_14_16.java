 ...
 * 死亡记录子集
 */
public class HDSD00_14_16 {
    private String CDA = "";
    public String toString() {
        return CDA;
    }

    public HDSD00_14_16(CDAData cdaData) {
        CDA =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                        ...
                        "        <id root=\"2.16.156.10011.1.5\" extension=\"0201306070\"/>\n" +
                        "        <name>xx医院</name>\n" +
                        ...
                        "      <assignedPerson>\n" +
                        "        <name名>" + cdaData.getCustomCol("DE02_01_039_00") + "</name>\n" +
                        "      </assignedPerson>\n" +
                        "    </assignedEntity>\n" +
                        "  </authenticator>\n" +
                        "  <authenticator>\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.11.3\" codeSystemName=\"诊断编码表(ICD-10)\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        ...
                        "              <text>" + cdaData.getCustomCol("DE06_00_296_00") + "</text>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
                        ...
                        "              <value xsi:type=\"TS\" value=\"" + cdaData.getCustomCol("DE02_01_036_00") + "\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\" codeSystem=\"2.16.156.10011.2.3.3.11.2\" codeSystemName=\"死因代码表（ICD-10）\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
                        ...
                        "              <value xsi:type=\"BL\" value=\"" + cdaData.getCustomCol("DE09_00_115_00") + "\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
