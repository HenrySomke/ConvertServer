 ...
 * 其他知情同意书子集
 */
public class HDSD00_10_01 {
    private String CDA = "";
    public String toString() {
        return CDA;
    }

    public HDSD00_10_01(CDAData cdaData) {
        CDA =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                        ...
                        "              <value xsi:type=\"CD\" code=\"" + cdaData.getCustomCol("DE05_01_024_00") + "\"  displayName=\"XX疾病\"  codeSystem=\"2.16.156.10011.2.3.3.11\" codeSystemName=\"ICD-10\"/>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
                        ...
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE09_00_117_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "          <entry>\n" +
                        "            <observation classCode=\"OBS\" moodCode=\"EVN\">\n" +
                        "              <code code=\"DE09.00.116.00\" codeSystem=\"2.16.156.10011.2.2.1\" codeSystemName=\"卫生信息数据元目录\" displayName=\"知情同意内容\"/>\n" +
                        "              <value xsi:type=\"ST\">" + cdaData.getCustomCol("DE09_00_116_00") + "</value>\n" +
                        "            </observation>\n" +
                        "          </entry>\n" +
                        "        </section>\n" +
                        "      </component>\n" +
