 ...
 */
public class JsonHDSD001002 extends BaseJsonPath{
    ...
    public Map<String, Object> getMap() {
        ...
        //核对字段
        map.put("DE06_00_302_00", "$.messageText.operationMode");
        map.put("DE05_01_075_00", "$.messageText.operationAccidents");
        map.put("DE02_01_039_00_FDDLR", "$.messageText.agentSign");
        map.put("DE09_00_053_00_HZQMRQ", "$.messageText.patientSignDate");
        map.put("DE02_01_039_00_HZQM", "$.messageText.patientSign");
        map.put("DE02_01_039_00", "$.messageText.patientInfo.name");
        map.put("DE06_00_340_00", "$.messageText.operationIndication");
        map.put("DE05_10_162_00", "$.messageText.operationAccidents");
        map.put("DE05_01_024_00", "$.messageText.preoperativeDiagnosis");
        map.put("DE02_01_040_00", "$.messageText.patientInfo.sex");
        map.put("DE06_00_018_00_YLJGYJ", "$.messageText.institutionsOpinions");
        map.put("DE02_01_039_00_JZYSQM", "$.messageText.doctorSign");
        ...
        map.put("DE06_00_301_00", "$.messageText.alternatives");//替代方案
        map.put("DE06_00_018_00_HZYJ", "$.messageText.patientProposal");//患者的意见
...
//        map.put("msg_emr_syncTime", "$.messageText.emrRecord.syncTime");
    ...
    public String getJsonPath() {
        return "./json/手术知情同意书json示例.json";
    }
    @Override
