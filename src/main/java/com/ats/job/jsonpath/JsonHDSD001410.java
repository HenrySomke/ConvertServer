 ...
 */
public class JsonHDSD001410 extends BaseJsonPath{
    ...
    public Map<String, Object> getMap() {
        ...
        //核对字段
        map.put("DE02_01_039_00_ZCR", "$.messageText.hostName");
        map.put("DE06_00_018_00_ZCRYJ", "$.messageText.hostSummary");
        ...
        map.put("DE06_00_018_00_TLYJ", "$.messageText.discussionOpinion");
...
//        map.put("msg_emr_syncTime", "$.messageText.emrRecord.syncTime");
    ...
    public String getJsonPath() {
        return "./json/疑难病例讨论记录json示例.json";
    }
    @Override
