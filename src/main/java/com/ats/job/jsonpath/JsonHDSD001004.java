 ...
 */
public class JsonHDSD001004 extends BaseJsonPath{
    ...
    public Map<String, Object> getMap() {
        ...
        map.put("DE02_01_039_00_MZYSQM", "$.messageText.doctorSign");
        map.put("DE09_00_053_00_MZYS", "$.messageText.doctorSignDate");
        map.put("DE05_01_075_00", "$.messageText.anaesthesiaAccidents");
        map.put("DE06_00_073_00", "$.messageText.anestheticMethod");
        map.put("DE06_00_093_00", "$.messageText.operationName");
...
//        map.put("msg_emr_syncTime", "$.messageText.emrRecord.syncTime");
    ...
    public String getJsonPath() {
        return "./json/麻醉知情同意书json示例.json";
    }
    @Override
