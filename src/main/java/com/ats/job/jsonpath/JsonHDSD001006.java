 ...
 */
public class JsonHDSD001006 extends BaseJsonPath{
    ...
    public Map<String, Object> getMap() {
        ...
        map.put("DE06_00_278_00", "$.messageText.informText");
        map.put("DE02_01_039_00_FDRQM", "$.messageText.agentSign");
        map.put("DE09_00_053_00_FDRQMRQ", "$.messageText.agentSignSignDate");
        map.put("DE02_10_024_00", "$.messageText.relationship");
        ...
        map.put("DE09_00_053_00_YSQM", "$.messageText.doctorSignDate");
        map.put("DE02_01_026_00", "$.messageText.patientInfo.age");

        map.put("DE06_00_183_00", "$.messageText.conditionSurvey");//病情概况以及主要抢救措施

        //时间字段
        map.put("DE09_00_053_00_BWTZRQ", "$.messageText.emrRecord.recTime");
        map.put("DE09_00_053_00_FDRQMRQ", "$.messageText.emrRecord.recTime");
        //新增字段
        map.put("pid", "$.pid");
        //多余字段
...
//        map.put("msg_emr_syncTime", "$.messageText.emrRecord.syncTime");
    ...
    public String getJsonPath() {
        return "./json/病危病重通知书json示例.json";
    }
    @Override
