 ...
 */
public class JsonHDSD001001 extends BaseJsonPath{
    ...
    public Map<String, Object> getMap() {
        ...
        map.put("DE09_00_116_00", "$.messageText.informText");
        map.put("DE02_01_039_00_FDDLR", "$.messageText.agentSign");
        map.put("DE02_10_024_00", "$.messageText.relationship");
        map.put("DE09_00_053_00_HZQM", "$.messageText.patientSignDate");
...
//        map.put("msg_emr_syncTime", "$.messageText.emrRecord.syncTime");
    ...
    public String getJsonPath() {
        return "./json/其他知情同意书json示例.json";
    }
    @Override
